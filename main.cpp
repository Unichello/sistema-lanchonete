    ...
    while (true) {
        ...
        if (perfil == 0) { //se for 0, para o programa
            ...
            while (true) { //menu do perfil do cliente
                ...
                std::cout << "2. Calcular Valor do Carrinho" << std::endl;
                std::cout << "3. Mostrar Carrinho" << std::endl;
                std::cout << "4. Excluir do Carrinho" << std::endl;
                ...
                if (opcao == 1) { //se escolher a opção 1 no menu, entra nesse outro menu onde se escolhe o tipo do produto
                    ...
                    if (tipoProduto == 1) {
                        ...
                        for (const Produto& sanduiche : sanduiches) {
                            if (sanduiche.nome == nomeSanduiche) {
                                cliente.adicionarAoCarrinho(sanduiche);
                                encontrado = true;
                                break;
                            }
                        }
                        ...
                        for (const Produto& suco : sucos) {
                            if (suco.nome == nomeSuco) {
                                cliente.adicionarAoCarrinho(suco);
                                encontrado = true;
                                break;
                            }
                        }
                    ...
                    double valor = cliente.calcularValorCarrinho();
                    ...
                    std::cin >> nomeProduto;
                    cliente.excluirDoCarrinho(nomeProduto);
            ...
            std::cin >> senha; //digitar a senha do gerente: admin
